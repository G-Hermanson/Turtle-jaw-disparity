...
#Post-review
#Additional plots of PC1 vs PC3 and PC1 vs PC4

#PC1 vs PC3

pdf('FigX-PCA_plot_PC1andPC3.pdf',width = 6.8, height = 6.8, useDingbats = F)

par(mfrow=c(2,2))

xlabel <- paste0('PC1 (', round(summary(pca)$importance[2,1]*100,1),'%)')
ylabel <- paste0('PC3 (', round(summary(pca)$importance[2,3]*100,1),'%)')
...
pdf('FigX-PCA_plot_PC1andPC4.pdf',width = 6.8, height = 6.8, useDingbats = F)

par(mfrow=c(2,2))

xlabel <- paste0('PC1 (', round(summary(pca)$importance[2,1]*100,1),'%)')
ylabel <- paste0('PC4 (', round(summary(pca)$importance[2,4]*100,1),'%)')
...
#Supplementary Figures/tables shown in Supplementary File S2
